...
# CONNECT TO DB
# app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///blog.db'  CHANGED FOR HEROKU
...
class BlogPost(db.Model, Base):
    ...
    # foreign key, tap into table name "users" and access id
    author_id = db.Column(db.Integer, db.ForeignKey('users.id'))
    # taps into User object, posts is the attribute in User class,
    # allows BlogPost(child) to access posts from parent class
...
class User(UserMixin, db.Model, Base):
    ...
    # posts is a list of BlogPost objects attached to user
...
def show_post(post_id):
    ...
    return render_template("post.html", post=requested_post, form=form, logged_in=current_user.is_authenticated, admin=admin)
